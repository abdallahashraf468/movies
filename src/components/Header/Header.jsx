...
const Header = () => {
  ...
  return (
    <>
      <nav className="bg-footercolor static top-0 left-0 right-0 py-2 text-2xl">
            ...
            <ul className="flex flex-col font-medium md:flex-row">
              <li>
                <NavLink
                  ...
                  className="block text-white py-2 px-3 md:bg-transparent"
                >
                  Home
                </NavLink>
              </li>
              <li>
                <NavLink
                  ...
                  className="block py-2 px-3 text-white rounded hover:bg-gray-100 md:hover:bg-transparent dark:hover:text-white md:dark:hover:bg-transparent"
                >
                  About us
                </NavLink>
              </li>
              {/* <li>
                <NavLink
                  ...
                  className="block py-2 px-3 md:hover:bg-transparent d:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 md:dark:hover:bg-transparent"
                >
                  Contact us
                </NavLink>
              </li> */}
              <li>
                <NavLink
                  ...
                  className="block py-2 px-3 md:hover:bg-transparent md:dark:hover:bg-transparent dark:border-gray-700"
                >
                  Movies
                </NavLink>
              </li>
              <li>
                <NavLink
                  ...
                  className="block py-2 px-3 md:dark:hover:bg-transparent dark:border-gray-700"
                >
                  Favorites

                  <Badge className="mx-2 text-xl" style={{ color: '#b91c1c' }} badgeContent={<span style={{ color: 'red', fontSize: '1.2rem', fontWeight:"bold" }}>{favorites.length}</span>}>
                    <span>
                      <FavoriteIcon style={{ color: '#b91c1c', fontSize: '1.9rem'  }} />
                    </span>
                  </Badge>
